 ...
 * @author solor
 */
public class Resultado_Encuesta extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        mostrar.setText("MOSTRAR RESULTADO");
    ...
    private void mostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mostrarActionPerformed
        ...
        {
            c = new conexion();
            res = c.consultar("select count(*) respuestas from respuestas where respuestas='A' and id_alumno = 1");
            while(res.next())
        ...
        {
            c = new conexion();
            res = c.consultar("select count(*) respuestas from respuestas where respuestas='B' and id_alumno = 1");
            while(res.next())
        ...
        {
            c = new conexion();
            res = c.consultar("select count(*) respuestas from respuestas where respuestas='C' and id_alumno = 1");
            while(res.next())
        ...
        {
            c = new conexion();
            res = c.consultar("select count(*) respuestas from respuestas where respuestas='D' and id_alumno = 1");
            while(res.next())
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resultado_Encuesta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
